...
namespace te_builtins
{
    ...
    [[nodiscard]] static te_type te_is_nan(te_type val)
    {
    ...
    {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ? te_parser::te_nan : static_cast<te_type>((val1 == val2) ? 1 : 0);
    }
    ...
    [[nodiscard]] static te_type te_round(te_type val, te_type decimalPlaces) // NOLINT
    {
        ...
        const size_t adjustedDecimalPlaces{ !std::isfinite(decimalPlaces) ? 0 : static_cast<size_t>(std::abs(decimalPlaces)) };
        ...
        if (!useNegativeRound) {
            if (val < 0) {
                return (decimalPosition == 0) ? std::ceil(val - ROUND_EPSILON) : std::ceil(static_cast<te_type>(val * decimalPosition) - ROUND_EPSILON) / decimalPosition;
            }
            return (decimalPosition == 0) ? std::floor(val + ROUND_EPSILON) : std::floor(static_cast<te_type>(val * decimalPosition) + ROUND_EPSILON) / decimalPosition;
        }
        // ROUND(21.5, -1) = 20
        if (val < 0) {
            return std::ceil(static_cast<te_type>(val / decimalPosition) - ROUND_EPSILON) * decimalPosition;
        }
        return std::floor(static_cast<te_type>(val / decimalPosition) + ROUND_EPSILON) * decimalPosition;
    }

    [[nodiscard]] static te_type te_nominal(te_type effectiveRate, te_type periods)
    {
    ...
    [[nodiscard]] static te_type te_effect(te_type nominalRate, te_type periods)
    {
    ...
    [[nodiscard]] static te_type te_asset_depreciation(te_type cost, te_type salvage, te_type life, te_type period, te_type month)
    {
        ...
        if (month < 1 || month > NUM_OF_MONTHS || life <= 0 || cost <= 0 || period < 1 || period >= (life + 2)) {
            return te_parser::te_nan;
        }
        ...
        return (period == life + 1) ? ((cost - priorDepreciation) * rate * (NUM_OF_MONTHS - month)) / NUM_OF_MONTHS : (cost - priorDepreciation) * rate;
    }
    ...
    [[nodiscard]] static te_type te_sum(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24)
    {
        const auto getSumMaybeNan = [](const auto val) { return (!std::isfinite(val) ? 0 : val); };

        return getSumMaybeNan(val1) + getSumMaybeNan(val2) + getSumMaybeNan(val3) + getSumMaybeNan(val4) + getSumMaybeNan(val5) + getSumMaybeNan(val6) + getSumMaybeNan(val7) + getSumMaybeNan(val8) + getSumMaybeNan(val9) + getSumMaybeNan(val10) + getSumMaybeNan(val11) + getSumMaybeNan(val12) + getSumMaybeNan(val13) + getSumMaybeNan(val14) + getSumMaybeNan(val15) + getSumMaybeNan(val16) + getSumMaybeNan(val17) + getSumMaybeNan(val18) + getSumMaybeNan(val19) + getSumMaybeNan(val20) + getSumMaybeNan(val21) + getSumMaybeNan(val22) + getSumMaybeNan(val23) + getSumMaybeNan(val24);
    }

    [[nodiscard]] static te_type te_average(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24)
    {
        const auto isValidMaybeNan = [](const auto val) { return (!std::isfinite(val) ? 0 : 1); };

        const auto validN = isValidMaybeNan(val1) + isValidMaybeNan(val2) + isValidMaybeNan(val3) + isValidMaybeNan(val4) + isValidMaybeNan(val5) + isValidMaybeNan(val6) + isValidMaybeNan(val7) + isValidMaybeNan(val8) + isValidMaybeNan(val9) + isValidMaybeNan(val10) + isValidMaybeNan(val11) + isValidMaybeNan(val12) + isValidMaybeNan(val13) + isValidMaybeNan(val14) + isValidMaybeNan(val15) + isValidMaybeNan(val16) + isValidMaybeNan(val17) + isValidMaybeNan(val18) + isValidMaybeNan(val19) + isValidMaybeNan(val20) + isValidMaybeNan(val21) + isValidMaybeNan(val22) + isValidMaybeNan(val23) + isValidMaybeNan(val24);
        const auto total = te_sum(val1, val2, val3, val4, val5, val6, val7, val8, val9, val10, val11, val12, val13, val14, val15, val16, val17, val18, val19, val20, val21, val22, val23, val24);
    ...
    [[nodiscard]] static te_type te_left_shift(te_type val1, te_type val2)
    {
        ...
        constexpr static auto MAX_BITNESS_PARAM = (te_parser::supports_64bit() ? te_parser::get_max_integer_bitness() - 1 : te_parser::get_max_integer_bitness());
        ...
        if (val2 < 0 || val2 > MAX_BITNESS_PARAM) {
            throw std::runtime_error("Additive expression of left shift (<<) operation must be between 0-" + std::to_string(MAX_BITNESS_PARAM));
        }
    ...
    [[nodiscard]] static te_type te_right_shift(te_type val1, te_type val2)
    {
        ...
        if (val2 < 0 || val2 > MAX_BITNESS_PARAM) {
            throw std::runtime_error("Additive expression of right shift (>>) operation must be between 0-" + std::to_string(MAX_BITNESS_PARAM));
        }
    ...
    [[nodiscard]] static te_type te_max(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24) noexcept
    {
    ...
    [[nodiscard]] static te_type te_min(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24) noexcept
    {
    ...
    {
        return !std::isfinite(val2MaybeNan) ? static_cast<te_type>(te_parser::number_to_bool(val1)) : static_cast<te_type>(te_parser::number_to_bool(val1) && te_parser::number_to_bool(val2MaybeNan));
    }

    [[nodiscard]] static te_type te_and_variadic(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24)
    {
    ...
    [[nodiscard]] static te_type te_or_variadic(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19, te_type val20, te_type val21, te_type val22, te_type val23, te_type val24)
    {
        // at least val1 must be legit, rest can be NaN
        if (!std::isfinite(val1)) {
            return te_parser::te_nan;
    ...
    [[nodiscard]] static te_type te_ifs(te_type if1, te_type if1True, te_type if2, te_type if2True, te_type if3, te_type if3True, te_type if4, te_type if4True, te_type if5, te_type if5True, te_type if6, te_type if6True, te_type if7, te_type if7True, te_type if8, te_type if8True, te_type if9, te_type if9True, te_type if10, te_type if10True, te_type if11, te_type if11True, te_type if12, te_type if12True)
    {
        return te_parser::number_to_bool(if1) ? if1True : te_parser::number_to_bool(if2) ? if2True : te_parser::number_to_bool(if3) ? if3True : te_parser::number_to_bool(if4) ? if4True : te_parser::number_to_bool(if5) ? if5True : te_parser::number_to_bool(if6) ? if6True : te_parser::number_to_bool(if7) ? if7True : te_parser::number_to_bool(if8) ? if8True : te_parser::number_to_bool(if9) ? if9True : te_parser::number_to_bool(if10) ? if10True : te_parser::number_to_bool(if11) ? if11True : te_parser::number_to_bool(if12) ? if12True : te_parser::te_nan;
    }
...
const std::set<te_variable> te_parser::m_functions = { // NOLINT
    { "abs", static_cast<te_fun1>(te_builtins::te_absolute_value), TE_PURE }, { "acos", static_cast<te_fun1>(te_builtins::te_acos), TE_PURE },
    // variadic, accepts 1-24 arguments
    { "and", static_cast<te_fun24>(te_builtins::te_and_variadic), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "asin", static_cast<te_fun1>(te_builtins::te_asin), TE_PURE }, { "atan", static_cast<te_fun1>(te_builtins::te_atan), TE_PURE }, { "atan2", static_cast<te_fun2>(te_builtins::te_atan2), TE_PURE }, { "average", static_cast<te_fun24>(te_builtins::te_average), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) },
#ifndef TE_FLOAT
    { "bitand", static_cast<te_fun2>(te_builtins::te_bitwise_and), TE_PURE }, { "bitor", static_cast<te_fun2>(te_builtins::te_bitwise_or), TE_PURE },
#if __cplusplus >= 202002L
    { "bitlrotate8", static_cast<te_fun2>(te_builtins::te_left_rotate8), TE_PURE }, { "bitrrotate8", static_cast<te_fun2>(te_builtins::te_right_rotate8), TE_PURE }, { "bitlrotate16", static_cast<te_fun2>(te_builtins::te_left_rotate16), TE_PURE }, { "bitrrotate16", static_cast<te_fun2>(te_builtins::te_right_rotate16), TE_PURE }, { "bitlrotate32", static_cast<te_fun2>(te_builtins::te_left_rotate32), TE_PURE }, { "bitrrotate32", static_cast<te_fun2>(te_builtins::te_right_rotate32), TE_PURE }, { "bitlrotate64", static_cast<te_fun2>(te_builtins::te_left_rotate64), TE_PURE }, { "bitrrotate64", static_cast<te_fun2>(te_builtins::te_right_rotate64), TE_PURE }, { "bitlrotate", static_cast<te_fun2>(te_builtins::te_left_rotate), TE_PURE }, { "bitrrotate", static_cast<te_fun2>(te_builtins::te_right_rotate), TE_PURE },
#endif
    { "bitnot8", static_cast<te_fun1>(te_builtins::te_bitwise_not8), TE_PURE }, { "bitnot16", static_cast<te_fun1>(te_builtins::te_bitwise_not16), TE_PURE }, { "bitnot32", static_cast<te_fun1>(te_builtins::te_bitwise_not32), TE_PURE }, { "bitnot64", static_cast<te_fun1>(te_builtins::te_bitwise_not64), TE_PURE }, { "bitnot", static_cast<te_fun1>(te_builtins::te_bitwise_not), TE_PURE }, { "bitlshift", static_cast<te_fun2>(te_builtins::te_left_shift_or_right), TE_PURE }, { "bitrshift", static_cast<te_fun2>(te_builtins::te_right_shift_or_left), TE_PURE }, { "bitxor", static_cast<te_fun2>(te_builtins::te_bitwise_xor), TE_PURE },
#endif
    ...
    TE_PURE },
    { "combin", static_cast<te_fun2>(te_builtins::te_ncr), TE_PURE }, { "cos", static_cast<te_fun1>(te_builtins::te_cos), TE_PURE }, { "cosh", static_cast<te_fun1>(te_builtins::te_cosh), TE_PURE }, { "cot", static_cast<te_fun1>(te_builtins::te_cot), TE_PURE }, { "db", static_cast<te_fun5>(te_builtins::te_asset_depreciation), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "e", static_cast<te_fun0>(te_builtins::te_e), TE_PURE }, { "effect", static_cast<te_fun2>(te_builtins::te_effect), TE_PURE }, { "even", static_cast<te_fun1>(te_builtins::te_even), TE_PURE }, { "exp", static_cast<te_fun1>(te_builtins::te_exp), TE_PURE }, { "fac", static_cast<te_fun1>(te_builtins::te_fac), TE_PURE }, { "fact", static_cast<te_fun1>(te_builtins::te_fac), TE_PURE }, { "false", static_cast<te_fun0>(te_builtins::te_false_value), TE_PURE }, { "floor", static_cast<te_fun1>(te_builtins::te_floor), TE_PURE }, { "iserr", static_cast<te_fun1>(te_builtins::te_is_nan), TE_PURE },
    { "iserror", static_cast<te_fun1>(te_builtins::te_is_nan), TE_PURE }, { "iseven", static_cast<te_fun1>(te_builtins::te_is_even), TE_PURE }, { "isna", static_cast<te_fun1>(te_builtins::te_is_nan), TE_PURE }, { "isnan", static_cast<te_fun1>(te_builtins::te_is_nan), TE_PURE }, { "isodd", static_cast<te_fun1>(te_builtins::te_is_odd), TE_PURE }, { "if", static_cast<te_fun3>(te_builtins::te_if), TE_PURE }, { "ifs", static_cast<te_fun24>(te_builtins::te_ifs), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "ln", static_cast<te_fun1>(te_builtins::te_log), TE_PURE }, { "log10", static_cast<te_fun1>(te_builtins::te_log10), TE_PURE }, { "max", static_cast<te_fun24>(te_builtins::te_max), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "maxint", static_cast<te_fun0>(te_builtins::te_max_integer), TE_PURE }, { "min", static_cast<te_fun24>(te_builtins::te_min), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) },
    { "mod", static_cast<te_fun2>(te_builtins::te_modulus), TE_PURE }, { "na", static_cast<te_fun0>(te_builtins::te_nan_value), TE_PURE }, { "nan", static_cast<te_fun0>(te_builtins::te_nan_value), TE_PURE }, { "ncr", static_cast<te_fun2>(te_builtins::te_ncr), TE_PURE }, { "nominal", static_cast<te_fun2>(te_builtins::te_nominal), TE_PURE }, { "not", static_cast<te_fun1>(te_builtins::te_not), TE_PURE }, { "npr", static_cast<te_fun2>(te_builtins::te_npr), TE_PURE }, { "odd", static_cast<te_fun1>(te_builtins::te_odd), TE_PURE }, { "or", static_cast<te_fun24>(te_builtins::te_or_variadic), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "permut", static_cast<te_fun2>(te_builtins::te_npr), TE_PURE }, { "pi", static_cast<te_fun0>(te_builtins::te_pi), TE_PURE }, { "pow", static_cast<te_fun2>(te_builtins::te_pow), TE_PURE }, { "power", /* Excel alias*/ static_cast<te_fun2>(te_builtins::te_pow), TE_PURE }, { "rand", static_cast<te_fun0>(te_builtins::te_random), TE_PURE },
    { "round", static_cast<te_fun2>(te_builtins::te_round), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "sign", static_cast<te_fun1>(te_builtins::te_sign), TE_PURE }, { "sin", static_cast<te_fun1>(te_builtins::te_sin), TE_PURE }, { "sinh", static_cast<te_fun1>(te_builtins::te_sinh), TE_PURE }, { "sqr", static_cast<te_fun1>(te_builtins::te_sqr), TE_PURE }, { "sqrt", static_cast<te_fun1>(te_builtins::te_sqrt), TE_PURE }, { "sum", static_cast<te_fun24>(te_builtins::te_sum), static_cast<te_variable_flags>(TE_PURE | TE_VARIADIC) }, { "supports32bit", static_cast<te_fun0>(te_builtins::te_supports_32bit), TE_PURE }, { "supports64bit", static_cast<te_fun0>(te_builtins::te_supports_64bit), TE_PURE }, { "tan", static_cast<te_fun1>(te_builtins::te_tan), TE_PURE }, { "tanh", static_cast<te_fun1>(te_builtins::te_tanh), TE_PURE }, { "tgamma", static_cast<te_fun1>(te_builtins::te_tgamma), TE_PURE }, { "true", static_cast<te_fun0>(te_builtins::te_true_value), TE_PURE },
    ...
    do // NOLINT
    {
        ...
        if (((*theState->m_next >= '0') && (*theState->m_next <= '9')) || (*theState->m_next == get_decimal_separator())) {
            ...
            if (is_letter(*theState->m_next) || (*theState->m_next == '_')) {
                ...
                m_varFound = false;
                const std::string_view currentVarToken{ start, static_cast<std::string::size_type>(theState->m_next - start) };
                        ...
                        try {
                            ...
                            if (m_unknownSymbolResolve.index() == 1) {
                                ...
                                if (std::isfinite(retUsrVal)) {
                                    ...
                                    m_currentVar = find_lookup(theState, currentVarToken);
                                    assert(m_currentVar != theState->m_lookup.cend() && "Internal error in parser using unknown symbol resolver.");
                                    if (m_currentVar != theState->m_lookup.cend()) {
                            ...
                            // "te_type usr(string_view, string&)" resolver
                                ...
                                const auto retUsrVal = std::get<2>(m_unknownSymbolResolve)(currentVarToken, m_lastErrorMessage);
                                if (std::isfinite(retUsrVal)) {
                                    add_variable_or_function({ te_variable::name_type{ currentVarToken }, retUsrVal });
                                    m_currentVar = find_lookup(theState, currentVarToken);
                                    assert(m_currentVar != theState->m_lookup.cend() && "Internal error in parser using unknown symbol resolver.");
                ...
                else if ((tok == '<' && (*theState->m_next == '<') && (*std::next(theState->m_next) == '<')) || (tok == '>' && (*theState->m_next == '>') && (*std::next(theState->m_next) == '>'))) {
                    theState->m_type = state::token_type::TOK_ERROR;
                }
#endif
#ifndef TE_FLOAT
...
te_expr *te_parser::base(state *theState)
{
    ...
    if (theState->m_type == state::token_type::TOK_OPEN) {
    ...
    else if (theState->m_type == state::token_type::TOK_NULL || theState->m_type == state::token_type::TOK_ERROR || theState->m_type == state::token_type::TOK_END || theState->m_type == state::token_type::TOK_SEP || theState->m_type == state::token_type::TOK_CLOSE || theState->m_type == state::token_type::TOK_INFIX) {
        ...
        if (theState->m_type != state::token_type::TOK_OPEN) {
            ...
            if (theState->m_type == state::token_type::TOK_CLOSE && (i != arity - 1) && varValid && is_variadic(openingVar->m_type)) {
                next_token(theState);
            }
...
te_expr *te_parser::expr_level1(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_or) {
...
te_expr *te_parser::expr_level2(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_and) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level3(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_bitwise_or) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level4(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_bitwise_xor) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level5(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_bitwise_and) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level6(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && (get_function2(theState->m_value) == te_builtins::te_equal || get_function2(theState->m_value) == te_builtins::te_not_equal)) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level7(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && (get_function2(theState->m_value) == te_builtins::te_less_than || get_function2(theState->m_value) == te_builtins::te_less_than_equal_to || get_function2(theState->m_value) == te_builtins::te_greater_than || get_function2(theState->m_value) == te_builtins::te_greater_than_equal_to)) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level8(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value)
           && (get_function2(theState->m_value) == te_builtins::te_left_shift || get_function2(theState->m_value) == te_builtins::te_right_shift
#if __cplusplus >= 202002L && !defined(TE_FLOAT)
               || get_function2(theState->m_value) == te_builtins::te_left_rotate || get_function2(theState->m_value) == te_builtins::te_right_rotate || get_function2(theState->m_value) == te_builtins::te_left_rotate32 || get_function2(theState->m_value) == te_builtins::te_right_rotate32 || get_function2(theState->m_value) == te_builtins::te_left_rotate16 || get_function2(theState->m_value) == te_builtins::te_right_rotate16 || get_function2(theState->m_value) == te_builtins::te_left_rotate8 || get_function2(theState->m_value) == te_builtins::te_right_rotate8
#endif
           )) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::expr_level9(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && (get_function2(theState->m_value) == te_builtins::te_add || get_function2(theState->m_value) == te_builtins::te_sub)) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::term(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && (get_function2(theState->m_value) == te_builtins::te_mul || get_function2(theState->m_value) == te_builtins::te_divide || get_function2(theState->m_value) == te_builtins::te_modulus)) {
        const te_fun2 func = get_function2(theState->m_value);
        next_token(theState);
...
te_expr *te_parser::factor(te_parser::state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX && is_function2(theState->m_value) && (get_function2(theState->m_value) == static_cast<te_fun2>(te_builtins::te_pow))) {
...
te_expr *te_parser::power(state *theState)
{
    ...
    while (theState->m_type == state::token_type::TOK_INFIX
           && ((is_function2(theState->m_value) && (get_function2(theState->m_value) == te_builtins::te_add || get_function2(theState->m_value) == te_builtins::te_sub))
#ifndef TE_FLOAT
               || (is_function1(theState->m_value) && (get_function1(theState->m_value) == te_builtins::te_bitwise_not))
#endif
           )) {
        if (is_function2(theState->m_value) && get_function2(theState->m_value) == te_builtins::te_sub) {
            theSign = -theSign;
        }
        else if (is_function1(theState->m_value) && get_function1(theState->m_value) == te_builtins::te_bitwise_not) {
            bitwiseNot = true;
        }
        next_token(theState);
    }
...
te_type te_parser::te_eval(const te_expr *texp)
{
    ...
    // NOLINTBEGIN
    const auto M = [&texp = std::as_const(texp)](const size_t e) { return (e < texp->m_parameters.size()) ? te_eval(texp->m_parameters[e]) : te_nan; };
    ...
    [&, texp]<typename T0>(const T0 &var) -> te_type {
        ...
        if constexpr (te_is_closure_v<T>) {
            ...
            return std::apply(var, make_closure_arg_list(M, texp->m_parameters[n_args - 1], std::make_index_sequence<n_args - 1>{}));
        }
