...
namespace lsoda
{
    ...
    private:
        ...
        ptrdiff_t illin = 0, init = 0, mxstep, mxhnil, nhnil, ntrep = 0, nslast, nyh, ierpj, iersl, jcur, jstart, kflag, l, meth, miter, maxord, maxcor, msbp, mxncf, n, nq, nst, nfe, nje, nqu;
        T tsw, pdnorm;
    ...
    private:
        ...
        void correction(ptrdiff_t neq, T *y, funcT f, ptrdiff_t *corflag, T pnorm, T *del, T *delp, T *told, ptrdiff_t *ncf, T *rh, ptrdiff_t *m, const void *_data)
        /*
    ...
    public:
        void lsoda(funcT f, ptrdiff_t neq, T *y, T *t, T tout, ptrdiff_t itol, T *rtol, T *atol, ptrdiff_t itask, ptrdiff_t *istate, ptrdiff_t iopt, ptrdiff_t jt, ptrdiff_t iwork1, ptrdiff_t iwork2, ptrdiff_t iwork5, ptrdiff_t iwork6, ptrdiff_t iwork7, ptrdiff_t iwork8, ptrdiff_t iwork9, T rwork1, T rwork5, T rwork6, T rwork7, const void *_data)
        /*
        void
        ...
        */
...

        {
            ...
            T atoli, ayi, big, h0, hmax, hmx, rh, rtoli, tcrit, tdist, tnext, tol, tolsf, tp, size, sum, w0;
    ...
    template <typename T, typename funcT>
    ODEResult<T> integrate(funcT fn, const RP(T) y0, const RP(T) teval, RP(T) Y, const T min_step, const T max_step, const T h0, T _rtol, T _atol, const size_t n, const size_t m, const RP(T) max_norm, const RP(void) fargs)
    {
        T rwork1, rwork5, rwork6, rwork7;
        T t, tout, dst, tmp;
        ...
        for (i = 1; (size_t)i < m; i++) {
            ...
            lsoda_integrator.lsoda(fn, n, y - 1, &t, tout, itol, rtol, atol, itask, &istate, iopt, jt, iwork1, iwork2, iwork5, iwork6, iwork7, iwork8, iwork9, rwork1, rwork5, rwork6, rwork7, fargs);
            ...
            std::memcpy(&Y[i * n], y, n * sizeof(T));
        }

        free(y);
        return { (size_t)i, (size_t)lsoda_integrator.getnfe(), (size_t)lsoda_integrator.getjfe(), 0, (size_t)lsoda_integrator.getnst(), 0, 0, lsoda_integrator.gethu(), 0.0 };
    }
} // namespace lsoda
